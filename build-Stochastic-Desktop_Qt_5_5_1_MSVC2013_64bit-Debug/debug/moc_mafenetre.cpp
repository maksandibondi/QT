...
#include "../../Stochastic/mafenetre.h"
...
QT_MOC_LITERAL(1, 10, 9), // "heightMax"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11), // "changeWidth"
QT_MOC_LITERAL(4, 33, 6), // "_width"
QT_MOC_LITERAL(5, 40, 12), // "changeHeight"
QT_MOC_LITERAL(6, 53, 7) // "_height"

    },
    "MaFenetre\0heightMax\0\0changeWidth\0"
    "_width\0changeHeight\0_height"
};
...
void MaFenetre::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->heightMax(); break;
        case 1: _t->changeWidth((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->changeHeight((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MaFenetre::heightMax)) {
                *result = 0;
            }
        }
    }
